...
class ExtentOfLeftTopRightBottomTest {
	...
	void testEqualsObject() {
		assert extent.equals((Object)Extent.ofLeftTopRightBottom(10, 33, 47, 127));
		assert extent.equals((Object)extent);
		assert !extent.equals((Object)Extent.ofLeftTopRightBottom(10, 33, 47, 126));
	}
	
	@Test
	void testHashCode() {
		assert extent.hashCode() == Extent.ofLeftTopRightBottom(10, 33, 47, 127).hashCode();
		assert extent.hashCode() == extent.hashCode();
	}

	@Test
	void testToString() {
		assert extent.toString().equals(Extent.ofLeftTopRightBottom(10, 33, 47, 127).toString());
		assert !extent.toString().equals(Extent.ofLeftTopRightBottom(10, 33, 47, 126).toString());
	}
